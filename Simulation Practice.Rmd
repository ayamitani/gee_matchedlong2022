...
beta_mean <- colMeans(outbeta) # calculate the mean estimate of beta0 and beta1

beta <- matrix(c(beta0,beta1), nrow =1,ncol=2)
kable((beta_mean - beta) / beta, 
       caption = "Mean Relative Bias", col.names = c(("$\\beta_0$"), "$\\beta_1$"))
