...
# summary(ordgee(ordered(y) ~ trt + sqrtmonth + trt:sqrtmonth, id = id, 
#                waves=time, corstr=("exchangeable"), data = arthritis_long))
```
...
Table1<-htmlreg(list(mod1,mod2,mod3,mod4,mod5),single.row = FALSE,
          ...
          custom.model.names = c(" ","Independence","Exchangeable",
                                 "AR(1)","Unstructured"),
          caption="Table 1: Comparisons of GEE Regressions(N=303 individuals)", caption.above=TRUE)
...
Table2<-htmlreg(list(mod1_50,mod2_50,mod3_50,mod4_50,mod5_50),single.row = FALSE,
          ...
          custom.model.names = c(" ","Independence","Exchangeable",
                                 "AR(1)","Unstructured"),
          caption="Table 2: Comparisons of GEE Regressions(N=50 individuals)", caption.above=TRUE)
...
Table3<-htmlreg(list(mod1_20,mod2_20,mod3_20,mod4_20,mod5_20),single.row = FALSE,
          ...
          custom.model.names = c(" ","Independence","Exchangeable",
                                 "AR(1)","Unstructured"),
          caption="Table 3: Comparisons of GEE Regressions(N=20 individuals)", caption.above=TRUE)
