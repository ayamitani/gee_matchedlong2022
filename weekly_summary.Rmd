...
2. I calculated mean relative bias instead of mean bias of beta. Which one is more useful?

3. QLS can account for more than one correlation (in our case we have within-subject & within pair), but we are using GEE for now. Does it mean we're focusing on the within-subject correlation and ignoring the within-pair correlation?


**Meet with Sudip & Steve on Mar 24**
