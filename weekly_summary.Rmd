...
5. Presentation:
  + should i only talk about the first simulation method? What about the 3 overlapping scenarios?
  + Which table should i present and how to interpret the result?
  + Do I still need to show the linear mixed model?
