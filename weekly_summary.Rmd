...
## Questions
1. For the variable "day2vst"/"yr2vst", should we exclude observations that have negative values on this variable? (i.e. should we only include measurements that took place after operation?)
...
2. Some patients had repeated aortic surgery. We need to compare the measurement date("mdate") and re-operation date, then exclude observations that measured the outcomes after re-operation.
  + check "yr2ao_reop" vs "yr2vst" (i.e. for those who did re-operation, year until measurement should be less than year until re-operation) ? 
